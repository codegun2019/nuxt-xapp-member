<template>
  <div class="bg-white rounded-lg shadow-md p-6 mb-6">
    ...
    <div class="text-pink-500 font-medium mb-4">ภารกิจรับรางวัล</div>
    

    <!-- รางวัลพิเศษวันที่ 7 -->
    <div class="bg-pink-50 rounded-lg p-4 text-center mb-6">
      <div class="text-pink-500 font-medium mb-2">เช็คอินครบ7วันแล้ว!</div>
...
import BonusActivityItem from '~/components/checkin/BonusActivityItem.vue'
...
const bonusActivities = [
  { icon: 'CalendarIcon', title: 'เช็คอิน 7 วันติดต่อกัน', description: 'รับโบนัสเพิ่ม', points: 200 },
  { icon: 'PuzzlePieceIcon', title: 'เล่นเกมครบ 35 เกม', description: 'เล่นเกม 2 เกมต่างกันในวัน', points: 100 },
  { icon: 'BanknotesIcon', title: 'ฝากเงินครบ 20 ครั้ง', description: 'ฝากเงิน 2 ครั้งในวัน', points: 150 }
]
</script>
